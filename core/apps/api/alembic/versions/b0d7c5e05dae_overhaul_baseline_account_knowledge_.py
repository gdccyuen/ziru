...
def upgrade() -> None:
    ...
    # Seed default system limits (previously fbe1c2d3e4f5 + baseline defaults).
    op.execute("""
        INSERT INTO system_limits (method, api_pattern, priority, rpm, period, description)
        VALUES ('GET', '/v1/jobs/*', 200, 200, 'minute', 'Job queries - prevent polling')
""")
    op.execute("""
        INSERT INTO system_limits (method, api_pattern, priority, rpm, period, description)
        VALUES ('GET', '/v2/jobs/*', 200, 200, 'minute', 'Job queries - prevent polling')
""")
    op.execute("""
        INSERT INTO system_limits (method, api_pattern, priority, rpm, period, description)
        VALUES ('*', '*', 9999, 1000, 'minute', 'Default for all unmatched endpoints')
""")
