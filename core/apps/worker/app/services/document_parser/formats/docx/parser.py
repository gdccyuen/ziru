...
from app.services.document_parser.formats.docx.toc import build_docx_toc_hierarchies
from app.services.document_parser.formats.text.parser import postprocess_leaf_dics
...
def _find_img_context(headings_stack, max_chars=100):
    ...
    """
    from app.services.document_parser.support.text_helpers import truncate_text
