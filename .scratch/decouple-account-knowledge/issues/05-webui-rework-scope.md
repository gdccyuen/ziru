...
- **Follow-up (PM):** the extra-attribute freedom (own-profile values + other dictionary attributes for specificity) also applies when a librarian **edits** a document's attributes — same picker behavior as upload.
